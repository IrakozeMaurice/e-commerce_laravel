    ...
    <header class="with-background">
        ...
        <div class="hero container">
            ...
            <div class="hero-image">
                <img src="{{ asset('img/laptop-removebg-preview.png') }}" alt="hero image">
            </div> <!-- end hero-image -->
        </div> <!-- end hero -->
    </header>
        ...
        <div class="container">
            ...
            <div class="blog-posts">
                <div class="blog-post" id="blog1">
                    <a href="#"><img src="{{ asset('img/blog4.jpg') }}" alt="Blog Image"></a>
                    <a href="#">
                ...
                <div class="blog-post" id="blog2">
                    <a href="#"><img src="{{ asset('img/blog5.jpg') }}" alt="Blog Image"></a>
                    <a href="#">
                ...
                <div class="blog-post" id="blog3">
                    <a href="#"><img src="{{ asset('img/blog6.jpg') }}" alt="Blog Image"></a>
                    <a href="#">
